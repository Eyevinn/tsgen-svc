...
let ENCODING_PARAMS = {};
ENCODING_PARAMS[TYPE_TESTSRC_1080p25] = [ '-g', '50 '];
ENCODING_PARAMS[TYPE_TESTSRC_720p25] = [ '-g', '50 '];
...
function generateStreams(type, audioStreams, channels) {
  ...
  const drawText = [ 
    ...
    'drawtext=fontfile=/usr/share/fonts/truetype/freefont/FreeSansBold.ttf:fontsize=22:fontcolor=white:text=\'PTS %{pts}\':x=30:y=30,' +
